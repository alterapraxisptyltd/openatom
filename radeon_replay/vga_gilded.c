...
void run_replay(uint8_t goto_skippie)
{
	...
	radeon_write_old(0xe0, 0x01338040);
	radeon_read_old(0xe4); /* 00000001 */
	radeon_write_old(0xe4, 0x00000001);
	radeon_write_old(0xe0, 0x01338041);
	radeon_read_old(0xe4); /* 00000000 */
	radeon_write_old(0xe4, 0x00000001);
 ...
 end_of_asic_init:
	...
	radeon_write_old(0x0, 0x9ffffffc);
}
...
void replay_int10_c3(void)
{
 ...
 more_skippage:
	...
	radeon_read_sync(0x8680); /* 00000000 */
	radeon_write_old(0x48, 0x00010000);
	radeon_write_old(0x4c, 0x00010000);
	radeon_read_sync(0x1730); /* 00000002 */
	radeon_read_sync(0x173c); /* 00001000 */
	radeon_read_sync(0x6df0); /* 00006260 */
	...
	radeon_write_old(0xe0, 0x01222002);
	radeon_read_old(0xe0); /* 01222002 */
	radeon_write_old(0xe0, 0x01226006);
	radeon_read_old(0xe4); /* 402a2a00 */
	radeon_read_old(0xe0); /* 01226006 */
	radeon_write_old(0xe0, 0x01226006);
	radeon_write_old(0xe4, 0x402a0055);
	radeon_read_old(0xe0); /* 01226006 */
	radeon_write_old(0xe0, 0x01226086);
	radeon_read_old(0xe4); /* 402a2a00 */
	radeon_read_old(0xe0); /* 01226086 */
	radeon_write_old(0xe0, 0x01226086);
	radeon_write_old(0xe4, 0x402a0055);
	radeon_read_old(0xe0); /* 01226086 */
	radeon_write_old(0xe0, 0x01226106);
	radeon_read_old(0xe4); /* 402a2a00 */
	radeon_read_old(0xe0); /* 01226106 */
	radeon_write_old(0xe0, 0x01226106);
	radeon_write_old(0xe4, 0x402a0055);
	radeon_read_old(0xe0); /* 01226106 */
	radeon_write_old(0xe0, 0x01226186);
	radeon_read_old(0xe4); /* 402a2a00 */
	radeon_read_old(0xe0); /* 01226186 */
	radeon_write_old(0xe0, 0x01226186);
	radeon_write_old(0xe4, 0x402a0055);
	radeon_read_old(0xe0); /* 01226186 */
	radeon_write_old(0xe0, 0x01226005);
	radeon_read_old(0xe4); /* 00000000 */
	radeon_read_old(0xe0); /* 01226005 */
	radeon_write_old(0xe0, 0x01226005);
	radeon_write_old(0xe4, 0x00000000);
	radeon_read_old(0xe0); /* 01226005 */
	radeon_write_old(0xe0, 0x01226085);
	radeon_read_old(0xe4); /* 00000000 */
	radeon_read_old(0xe0); /* 01226085 */
	radeon_write_old(0xe0, 0x01226085);
	radeon_write_old(0xe4, 0x00000000);
	radeon_read_old(0xe0); /* 01226085 */
	radeon_write_old(0xe0, 0x01226105);
	radeon_read_old(0xe4); /* 00000000 */
	radeon_read_old(0xe0); /* 01226105 */
	radeon_write_old(0xe0, 0x01226105);
	radeon_write_old(0xe4, 0x00000000);
	radeon_read_old(0xe0); /* 01226105 */
	radeon_write_old(0xe0, 0x01226185);
	radeon_read_old(0xe4); /* 00000000 */
	radeon_read_old(0xe0); /* 01226185 */
	radeon_write_old(0xe0, 0x01226185);
	radeon_write_old(0xe4, 0x00000000);
	radeon_read_old(0xe0); /* 01226185 */
	radeon_write_old(0xe0, 0x01226205);
	radeon_read_old(0xe4); /* 00000000 */
	radeon_read_old(0xe0); /* 01226205 */
	radeon_write_old(0xe0, 0x01226205);
	radeon_write_old(0xe4, 0x00000000);
	radeon_read_old(0xe0); /* 01226205 */
	radeon_write_old(0xe0, 0x01226285);
	radeon_read_old(0xe4); /* 00000000 */
	radeon_read_old(0xe0); /* 01226285 */
	radeon_write_old(0xe0, 0x01226285);
	radeon_write_old(0xe4, 0x00000000);
	radeon_read_old(0xe0); /* 01226285 */
	radeon_write_old(0xe0, 0x01226305);
	radeon_read_old(0xe4); /* 00000000 */
	radeon_read_old(0xe0); /* 01226305 */
	radeon_write_old(0xe0, 0x01226305);
	radeon_write_old(0xe4, 0x00000000);
	radeon_read_old(0xe0); /* 01226305 */
	radeon_write_old(0xe0, 0x01226385);
	radeon_read_old(0xe4); /* 00000000 */
	radeon_read_old(0xe0); /* 01226385 */
	radeon_write_old(0xe0, 0x01226385);
	radeon_write_old(0xe4, 0x00000000);
	radeon_write_old(0xe0, 0x01120011);
	radeon_read_old(0xe4); /* 00000300 */
	radeon_write_old(0xe4, 0x00000300);
	radeon_read_sync(0x611c); /* 00000002 */
	radeon_read_sync(0x5c18); /* 00011000 */
	radeon_write_sync(0x5c18, 0x00011010);
	radeon_write_old(0xe0, 0x0132804c);
	radeon_read_old(0xe4); /* 00000701 */
	radeon_write_old(0xe4, 0x00000701);
	radeon_write_old(0xe0, 0x01222002);
	radeon_read_old(0xe0); /* 01222002 */
	radeon_write_old(0xe0, 0x01220009);
	radeon_write_old(0xe4, 0x00000000);
	radeon_read_sync(0x671c); /* 00010506 */
	radeon_write_sync(0x671c, 0x00010506);
	radeon_read_sync(0x6718); /* 00000000 */
